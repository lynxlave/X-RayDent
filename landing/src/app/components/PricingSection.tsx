import { Check, Star, Zap, Building2, Rocket, Users } from 'lucide-react';
...
export function PricingSection() {
  return (
    <section
      id="pricing"
      className="relative py-20 lg:py-32 overflow-hidden bg-gradient-to-b from-white to-[#0B3C5D]/5"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#00E5FF]/10 to-[#7B61FF]/10 border border-[#00E5FF]/20 mb-6">
            ...
            <span className="text-sm font-medium text-[#0B3C5D]">Тарифные планы</span>
          </div>
          ...
          {pricingPlans.map((plan) => (
            <div
              ...
              className={`group relative rounded-2xl transition-all duration-500 hover:scale-[1.02] ${
                plan.highlight ? 'lg:col-span-1 lg:row-span-1' : ''
              }`}
            >
              {plan.highlight && (
              ...
              >
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="pt-2">
                    ...
                    {plan.pricePerUnit && (
                      <div className="text-sm font-medium text-[#0B3C5D]/80 mt-1">
                        {plan.pricePerUnit}
                      </div>
                    )}
                  </div>
                ...
                <div className="text-xs text-[#0B3C5D]/60 mb-6 italic">Для: {plan.targetAudience}</div>
        ...
        <div className="text-center mt-12">
          ...
          <NeonButton
            ...
            size="lg"
          >
            <span className="font-semibold text-white">Получить консультацию</span>
          </NeonButton>
        </div>
      </div>
    </section>
