      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#0B3C5D]/70 max-w-2xl mx-auto">
            X-РайДент трансформирует рабочий процесс вашей
            клиники
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="group relative p-8 rounded-3xl bg-white/80 backdrop-blur-sm border border-[#0B3C5D]/10 hover:border-[#00E5FF]/50 transition-all duration-300 hover:shadow-2xl hover:shadow-[#00E5FF]/20 overflow-hidden"
            >
              ...
              <div className="relative space-y-4">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div
                    className={`flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br ${benefit.color} p-[2px]`}
                  >
          ...
          <div className="inline-block p-8 lg:p-12 rounded-3xl bg-gradient-to-br from-[#0B3C5D] to-[#0B3C5D]/80 relative overflow-hidden">
            ...
            <div className="relative space-y-6 max-w-2xl mx-auto">
              ...
              <p className="text-lg text-white/80">
                Присоединяйтесь к передовым стоматологическим
                клиникам, которые уже используют X-РайДент
              </p>
              <button
                onClick={() =>
                ...
                className="group relative px-10 py-5 rounded-2xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#00E5FF]/50"
              >
